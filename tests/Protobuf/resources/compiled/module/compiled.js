...
export const oip5 = $root.oip5 = (() => {
  ...
  oip5.OipFive = (function () {
    ...
    OipFive.encode = function encode (message, writer) {
      ...
      if (message.recordTemplate != null && message.hasOwnProperty('recordTemplate')) { $root.oip5.record.RecordTemplateProto.encode(message.recordTemplate, writer.uint32(/* id 1, wireType 2 = */10).fork()).ldelim() }
      if (message.record != null && message.hasOwnProperty('record')) { $root.oip5.RecordProto.encode(message.record, writer.uint32(/* id 2, wireType 2 = */18).fork()).ldelim() }
      if (message.transfer != null && message.hasOwnProperty('transfer')) { $root.oip5.Transfer.encode(message.transfer, writer.uint32(/* id 7, wireType 2 = */58).fork()).ldelim() }
      if (message.deactivate != null && message.hasOwnProperty('deactivate')) { $root.oip5.Deactivate.encode(message.deactivate, writer.uint32(/* id 8, wireType 2 = */66).fork()).ldelim() }
      if (message.edit != null && message.hasOwnProperty('edit')) { $root.oip5.Edit.encode(message.edit, writer.uint32(/* id 9, wireType 2 = */74).fork()).ldelim() }
      return writer
    }
    ...
    OipFive.decode = function decode (reader, length) {
      ...
      let end = length === undefined ? reader.len : reader.pos + length; let message = new $root.oip5.OipFive()
    ...
    OipFive.fromObject = function fromObject (object) {
      if (object instanceof $root.oip5.OipFive) { return object }
      let message = new $root.oip5.OipFive()
      if (object.recordTemplate != null) {
        if (typeof object.recordTemplate !== 'object') { throw TypeError('.oip5.OipFive.recordTemplate: object expected') }
        message.recordTemplate = $root.oip5.record.RecordTemplateProto.fromObject(object.recordTemplate)
      }
      if (object.record != null) {
        if (typeof object.record !== 'object') { throw TypeError('.oip5.OipFive.record: object expected') }
        message.record = $root.oip5.RecordProto.fromObject(object.record)
      }
      if (object.transfer != null) {
        if (typeof object.transfer !== 'object') { throw TypeError('.oip5.OipFive.transfer: object expected') }
        message.transfer = $root.oip5.Transfer.fromObject(object.transfer)
      }
      if (object.deactivate != null) {
        if (typeof object.deactivate !== 'object') { throw TypeError('.oip5.OipFive.deactivate: object expected') }
        message.deactivate = $root.oip5.Deactivate.fromObject(object.deactivate)
      }
      if (object.edit != null) {
        if (typeof object.edit !== 'object') { throw TypeError('.oip5.OipFive.edit: object expected') }
    ...
    OipFive.toObject = function toObject (message, options) {
      ...
      if (message.recordTemplate != null && message.hasOwnProperty('recordTemplate')) { object.recordTemplate = $root.oip5.record.RecordTemplateProto.toObject(message.recordTemplate, options) }
      if (message.record != null && message.hasOwnProperty('record')) { object.record = $root.oip5.RecordProto.toObject(message.record, options) }
      if (message.transfer != null && message.hasOwnProperty('transfer')) { object.transfer = $root.oip5.Transfer.toObject(message.transfer, options) }
      if (message.deactivate != null && message.hasOwnProperty('deactivate')) { object.deactivate = $root.oip5.Deactivate.toObject(message.deactivate, options) }
      if (message.edit != null && message.hasOwnProperty('edit')) { object.edit = $root.oip5.Edit.toObject(message.edit, options) }
      return object
    }
  ...
  oip5.RecordProto = (function () {
    ...
    RecordProto.decode = function decode (reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      let end = length === undefined ? reader.len : reader.pos + length; let message = new $root.oip5.RecordProto()
      while (reader.pos < end) {
        let tag = reader.uint32()
        switch (tag >>> 3) {
          default:
    ...
    RecordProto.fromObject = function fromObject (object) {
      if (object instanceof $root.oip5.RecordProto) { return object }
  ...
  oip5.Transfer = (function () {
    ...
    Transfer.decode = function decode (reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      let end = length === undefined ? reader.len : reader.pos + length; let message = new $root.oip5.Transfer()
      while (reader.pos < end) {
        let tag = reader.uint32()
        switch (tag >>> 3) {
          default:
    ...
    Transfer.fromObject = function fromObject (object) {
      if (object instanceof $root.oip5.Transfer) { return object }
  ...
  oip5.Deactivate = (function () {
    ...
    Deactivate.decode = function decode (reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      let end = length === undefined ? reader.len : reader.pos + length; let message = new $root.oip5.Deactivate()
      while (reader.pos < end) {
        let tag = reader.uint32()
        switch (tag >>> 3) {
          default:
    ...
    Deactivate.fromObject = function fromObject (object) {
      if (object instanceof $root.oip5.Deactivate) { return object }
  ...
  oip5.Edit = (function () {
    ...
    Edit.decode = function decode (reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      let end = length === undefined ? reader.len : reader.pos + length; let message = new $root.oip5.Edit()
      while (reader.pos < end) {
        let tag = reader.uint32()
        switch (tag >>> 3) {
          default:
    ...
    Edit.fromObject = function fromObject (object) {
      if (object instanceof $root.oip5.Edit) { return object }
  ...
  oip5.record = (function () {
    ...
    record.RecordTemplateProto = (function () {
      ...
      RecordTemplateProto.encode = function encode (message, writer) {
        if (!writer) { writer = $Writer.create() }
        if (message.friendlyName != null && message.hasOwnProperty('friendlyName')) { writer.uint32(/* id 1, wireType 2 = */10).string(message.friendlyName) }
        ...
        if (message.DescriptorSetProto != null && message.hasOwnProperty('DescriptorSetProto')) { writer.uint32(/* id 4, wireType 2 = */34).bytes(message.DescriptorSetProto) }
        if (message.identifier != null && message.hasOwnProperty('identifier')) { writer.uint32(/* id 10, wireType 1 = */81).fixed64(message.identifier) }
        if (message.recommended != null && message.recommended.length) {
          writer.uint32(/* id 11, wireType 2 = */90).fork()
          for (let i = 0; i < message.recommended.length; ++i) { writer.fixed64(message.recommended[i]) }
          writer.ldelim()
        }
        if (message.required != null && message.required.length) {
          writer.uint32(/* id 12, wireType 2 = */98).fork()
          for (let i = 0; i < message.required.length; ++i) { writer.fixed64(message.required[i]) }
          writer.ldelim()
        }
        return writer
      }
      ...
      RecordTemplateProto.decode = function decode (reader, length) {
        if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
        let end = length === undefined ? reader.len : reader.pos + length; let message = new $root.oip5.record.RecordTemplateProto()
        while (reader.pos < end) {
          let tag = reader.uint32()
          switch (tag >>> 3) {
            case 1:
            ...
            case 10:
              ...
              break
            case 11:
              if (!(message.recommended && message.recommended.length)) { message.recommended = [] }
              if ((tag & 7) === 2) {
                let end2 = reader.uint32() + reader.pos
                while (reader.pos < end2) { message.recommended.push(reader.fixed64()) }
              } else { message.recommended.push(reader.fixed64()) }
              break
            case 12:
              if (!(message.required && message.required.length)) { message.required = [] }
              if ((tag & 7) === 2) {
                let end2 = reader.uint32() + reader.pos
                while (reader.pos < end2) { message.required.push(reader.fixed64()) }
              } else { message.required.push(reader.fixed64()) }
              break
            default:
              reader.skipType(tag & 7)
              break
      ...
      RecordTemplateProto.verify = function verify (message) {
        ...
        if (message.friendlyName != null && message.hasOwnProperty('friendlyName')) {
          if (!$util.isString(message.friendlyName)) { return 'friendlyName: string expected' }
        }
        ...
        if (message.DescriptorSetProto != null && message.hasOwnProperty('DescriptorSetProto')) {
          if (!(message.DescriptorSetProto && typeof message.DescriptorSetProto.length === 'number' || $util.isString(message.DescriptorSetProto))) { return 'DescriptorSetProto: buffer expected' }
        }
        if (message.identifier != null && message.hasOwnProperty('identifier')) {
          if (!$util.isInteger(message.identifier) && !(message.identifier && $util.isInteger(message.identifier.low) && $util.isInteger(message.identifier.high))) { return 'identifier: integer|Long expected' }
        }
        if (message.recommended != null && message.hasOwnProperty('recommended')) {
          if (!Array.isArray(message.recommended)) { return 'recommended: array expected' }
          for (let i = 0; i < message.recommended.length; ++i) {
            if (!$util.isInteger(message.recommended[i]) && !(message.recommended[i] && $util.isInteger(message.recommended[i].low) && $util.isInteger(message.recommended[i].high))) { return 'recommended: integer|Long[] expected' }
          }
        }
        if (message.required != null && message.hasOwnProperty('required')) {
          ...
          for (let i = 0; i < message.required.length; ++i) {
            if (!$util.isInteger(message.required[i]) && !(message.required[i] && $util.isInteger(message.required[i].low) && $util.isInteger(message.required[i].high))) { return 'required: integer|Long[] expected' }
          }
        }
        return null
      }
      ...
      RecordTemplateProto.fromObject = function fromObject (object) {
        if (object instanceof $root.oip5.record.RecordTemplateProto) { return object }
        ...
        if (object.DescriptorSetProto != null) {
          if (typeof object.DescriptorSetProto === 'string') { $util.base64.decode(object.DescriptorSetProto, message.DescriptorSetProto = $util.newBuffer($util.base64.length(object.DescriptorSetProto)), 0) } else if (object.DescriptorSetProto.length) { message.DescriptorSetProto = object.DescriptorSetProto }
        }
        if (object.identifier != null) {
          if ($util.Long) { (message.identifier = $util.Long.fromValue(object.identifier)).unsigned = false } else if (typeof object.identifier === 'string') { message.identifier = parseInt(object.identifier, 10) } else if (typeof object.identifier === 'number') { message.identifier = object.identifier } else if (typeof object.identifier === 'object') { message.identifier = new $util.LongBits(object.identifier.low >>> 0, object.identifier.high >>> 0).toNumber() }
        }
        if (object.recommended) {
          if (!Array.isArray(object.recommended)) { throw TypeError('.oip5.record.RecordTemplateProto.recommended: array expected') }
          message.recommended = []
          for (let i = 0; i < object.recommended.length; ++i) {
            if ($util.Long) { (message.recommended[i] = $util.Long.fromValue(object.recommended[i])).unsigned = false } else if (typeof object.recommended[i] === 'string') { message.recommended[i] = parseInt(object.recommended[i], 10) } else if (typeof object.recommended[i] === 'number') { message.recommended[i] = object.recommended[i] } else if (typeof object.recommended[i] === 'object') { message.recommended[i] = new $util.LongBits(object.recommended[i].low >>> 0, object.recommended[i].high >>> 0).toNumber() }
          }
        }
        if (object.required) {
          if (!Array.isArray(object.required)) { throw TypeError('.oip5.record.RecordTemplateProto.required: array expected') }
          message.required = []
          for (let i = 0; i < object.required.length; ++i) {
            if ($util.Long) { (message.required[i] = $util.Long.fromValue(object.required[i])).unsigned = false } else if (typeof object.required[i] === 'string') { message.required[i] = parseInt(object.required[i], 10) } else if (typeof object.required[i] === 'number') { message.required[i] = object.required[i] } else if (typeof object.required[i] === 'object') { message.required[i] = new $util.LongBits(object.required[i].low >>> 0, object.required[i].high >>> 0).toNumber() }
          }
        }
        return message
      }
      ...
      RecordTemplateProto.toObject = function toObject (message, options) {
        ...
        if (options.defaults) {
          ...
          } else { object.identifier = options.longs === String ? '0' : 0 }
        }
        ...
        if (message.identifier != null && message.hasOwnProperty('identifier')) {
          if (typeof message.identifier === 'number') { object.identifier = options.longs === String ? String(message.identifier) : message.identifier } else { object.identifier = options.longs === String ? $util.Long.prototype.toString.call(message.identifier) : options.longs === Number ? new $util.LongBits(message.identifier.low >>> 0, message.identifier.high >>> 0).toNumber() : message.identifier }
        }
        if (message.recommended && message.recommended.length) {
          object.recommended = []
          for (let j = 0; j < message.recommended.length; ++j) {
            if (typeof message.recommended[j] === 'number') { object.recommended[j] = options.longs === String ? String(message.recommended[j]) : message.recommended[j] } else { object.recommended[j] = options.longs === String ? $util.Long.prototype.toString.call(message.recommended[j]) : options.longs === Number ? new $util.LongBits(message.recommended[j].low >>> 0, message.recommended[j].high >>> 0).toNumber() : message.recommended[j] }
          }
        }
        if (message.required && message.required.length) {
          object.required = []
          for (let j = 0; j < message.required.length; ++j) {
            if (typeof message.required[j] === 'number') { object.required[j] = options.longs === String ? String(message.required[j]) : message.required[j] } else { object.required[j] = options.longs === String ? $util.Long.prototype.toString.call(message.required[j]) : options.longs === Number ? new $util.LongBits(message.required[j].low >>> 0, message.required[j].high >>> 0).toNumber() : message.required[j] }
          }
        }
        return object
      }
...
export const oipProto = $root.oipProto = (() => {
  ...
  oipProto.SignedMessage = (function () {
    ...
    SignedMessage.encode = function encode (message, writer) {
      if (!writer) { writer = $Writer.create() }
      if (message.SerializedMessage != null && message.hasOwnProperty('SerializedMessage')) { writer.uint32(/* id 1, wireType 2 = */10).bytes(message.SerializedMessage) }
      ...
      if (message.SignatureType != null && message.hasOwnProperty('SignatureType')) { writer.uint32(/* id 3, wireType 0 = */24).int32(message.SignatureType) }
      if (message.PubKey != null && message.hasOwnProperty('PubKey')) { writer.uint32(/* id 4, wireType 2 = */34).bytes(message.PubKey) }
      if (message.Signature != null && message.hasOwnProperty('Signature')) { writer.uint32(/* id 5, wireType 2 = */42).bytes(message.Signature) }
      return writer
    }
    ...
    SignedMessage.decode = function decode (reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      let end = length === undefined ? reader.len : reader.pos + length; let message = new $root.oipProto.SignedMessage()
      while (reader.pos < end) {
        let tag = reader.uint32()
        switch (tag >>> 3) {
          case 1:
    ...
    SignedMessage.verify = function verify (message) {
      ...
      if (message.SerializedMessage != null && message.hasOwnProperty('SerializedMessage')) {
        if (!(message.SerializedMessage && typeof message.SerializedMessage.length === 'number' || $util.isString(message.SerializedMessage))) { return 'SerializedMessage: buffer expected' }
      }
    ...
    SignedMessage.fromObject = function fromObject (object) {
      ...
      if (object.SerializedMessage != null) {
        if (typeof object.SerializedMessage === 'string') { $util.base64.decode(object.SerializedMessage, message.SerializedMessage = $util.newBuffer($util.base64.length(object.SerializedMessage)), 0) } else if (object.SerializedMessage.length) { message.SerializedMessage = object.SerializedMessage }
      }
      ...
      if (object.PubKey != null) {
        if (typeof object.PubKey === 'string') { $util.base64.decode(object.PubKey, message.PubKey = $util.newBuffer($util.base64.length(object.PubKey)), 0) } else if (object.PubKey.length) { message.PubKey = object.PubKey }
      }
      if (object.Signature != null) {
        if (typeof object.Signature === 'string') { $util.base64.decode(object.Signature, message.Signature = $util.newBuffer($util.base64.length(object.Signature)), 0) } else if (object.Signature.length) { message.Signature = object.Signature }
      }
      return message
    }
